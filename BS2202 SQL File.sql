...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-05-08 05:05:13',NULL),('diagnostics.include_raw','OFF','2023-05-08 05:05:13',NULL),('ps_thread_trx_info.max_length','65535','2023-05-08 05:05:13',NULL),('statement_performance_analyzer.limit','100','2023-05-08 05:05:13',NULL),('statement_performance_analyzer.view',NULL,'2023-05-08 05:05:13',NULL),('statement_truncate_len','64','2023-05-08 05:05:13',NULL);
...
-- Dump completed on 2023-06-06 13:56:36
-- MySQL dump 10.13  Distrib 8.0.33, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: loanshark
-- ------------------------------------------------------
-- Server version	8.0.33
...
CREATE TABLE `book` (
  ...
  `BookLength` int DEFAULT NULL,
  `Author` varchar(45) DEFAULT NULL,
  `PaperbackAvailable` int DEFAULT NULL,
  `HardbackAvailable` int DEFAULT NULL,
  `AudiobookAvailable` int DEFAULT NULL,
  PRIMARY KEY (`BookID`),
  UNIQUE KEY `BookID_UNIQUE` (`BookID`),
  UNIQUE KEY `ItemID_UNIQUE` (`ItemID`),
  CONSTRAINT `BookItemID` FOREIGN KEY (`ItemID`) REFERENCES `item` (`ItemID`)
...
INSERT INTO `book` VALUES (1,'IT000193',369,'Andy Weir',6,3,1),(2,'IT040207',896,'Frank Herbert',2,4,0),(3,'IT203213',84,'H.G. Wells',8,-1,4),(4,'IT903263',656,'Walter Isaacson',10,5,1),(5,'IT204973',464,'Stephen Fry',3,-1,1);
...
CREATE TABLE `customer` (
  ...
  `CurrentLoans` tinyint NOT NULL,
  `EventNumber1` char(8) DEFAULT NULL,
  `EventNumber2` char(8) DEFAULT NULL,
  `EventNumber3` char(8) DEFAULT NULL,
  `EventNumber4` char(8) DEFAULT NULL,
  `EventNumber5` char(8) DEFAULT NULL,
...
INSERT INTO `customer` VALUES ('CU054137',2,'LE830568','LE397384',NULL,NULL,NULL),('CU061144',2,'LE395423','LE158883',NULL,NULL,NULL),('CU388741',2,'LE300631','LE445492',NULL,NULL,NULL),('CU545591',1,'LE950585',NULL,NULL,NULL,NULL),('CU627866',1,'LE023830',NULL,NULL,NULL,NULL),('CU942695',0,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `employee` (
  ...
  `employeeAdminBool` tinyint NOT NULL,
...
INSERT INTO `employee` VALUES (1,'Admin','Password',1),(2,'Regular','251221',0);
...
CREATE TABLE `item` (
  ...
  `IsBook` tinyint NOT NULL,
  `ReleaseYear` int NOT NULL,
  `TotalCopies` tinyint NOT NULL,
  `CopiesAvailable` varchar(45) NOT NULL,
  `IsFiction` tinyint NOT NULL,
  `GenreTag1` varchar(15) DEFAULT NULL,
  `GenreTag2` varchar(15) DEFAULT NULL,
  `GenreTag3` varchar(15) DEFAULT NULL,
  `ReadingLevel` int DEFAULT NULL,
  `ItemPicture` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ItemID`),
  UNIQUE KEY `ItemID_UNIQUE` (`ItemID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `item` VALUES ('IT000193','The Martian',1,2011,12,'6',1,'Space','Drama','Comedy',2,'@../../assets/theMartian.jpg'),('IT040207','Dune',1,1965,15,'5',1,'Sci-Fi','Fantasy','Influential',4,NULL),('IT120326','Memento',0,2000,11,'4',1,'Action','Neo-Noir','Mystery',NULL,NULL),('IT203213','The Time Machine',1,1895,19,'12',1,'Sci-Fi','Fantasy','Dystopia',5,NULL),('IT203858','Inception',0,2010,10,'0',1,'Action','Thriller','Heist',NULL,NULL),('IT204973','Mythos',1,2017,12,'4',1,'Mythology','Folklore','Real Story',3,NULL),('IT295238','Free Solo',0,2018,6,'3',0,'Documentary','Sports','Thriller',NULL,NULL),('IT404294','Wolf Of Wall Street',0,2014,15,'5',1,'Comedy','Based on Truth','Dark',NULL,NULL),('IT410421','Blackfish',0,2013,9,'1',0,'Documentary','Nature','Modern',NULL,NULL),('IT903263','Steve Jobs',1,2011,20,'16',0,'Biography','Based on Truth','Science',3,NULL);
/*!40000 ALTER TABLE `item` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `loanevent`
--

DROP TABLE IF EXISTS `loanevent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `loanevent` (
  ...
  `ItemVersion` varchar(45) DEFAULT NULL,
  `VersionFee` decimal(19,2) DEFAULT NULL,
  PRIMARY KEY (`EventID`),
  UNIQUE KEY `EventID_UNIQUE` (`EventID`),
  KEY `CustomerID_idx` (`CustomerID`),
  KEY `ItemID_idx` (`ItemID`),
  CONSTRAINT `LoanCustomerID` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`CustomerID`),
  CONSTRAINT `LoanItemID` FOREIGN KEY (`ItemID`) REFERENCES `item` (`ItemID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `loanevent`
--

LOCK TABLES `loanevent` WRITE;
/*!40000 ALTER TABLE `loanevent` DISABLE KEYS */;
INSERT INTO `loanevent` VALUES ('LE023830','CU627866','IT120326','2023-04-29',1,'2023-05-29','Standard',1.00),('LE158883','CU061144','IT404294','2023-04-14',2,'2023-06-14','Standard',1.00),('LE300631','CU388741','IT295238','2023-05-23',2,'2023-07-23','DirCut',1.50),('LE395423','CU061144','IT120326','2023-06-01',3,'2023-09-01','Standard',1.00),('LE397384','CU054137','IT204973','2023-05-19',3,'2023-08-19','Audiobook',2.00),('LE445492','CU388741','IT040207','2023-05-23',2,'2023-07-23','Hardback',1.00),('LE594104','CU054137','IT000193','2023-06-06',2,'2023-08-06','Audiobook',1.00),('LE830568','CU054137','IT000193','2023-06-03',1,'2023-07-03','Paperback',0.50),('LE950585','CU545591','IT000193','2023-06-02',1,'2023-07-02','Hardback',0.50);
/*!40000 ALTER TABLE `loanevent` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `movie` (
  ...
  `StandardAvailable` int NOT NULL,
  `DirCutAvailable` int DEFAULT NULL,
  PRIMARY KEY (`MovieID`),
...
INSERT INTO `movie` VALUES (1,'IT404294',179,'Martin Scorsese','Leonardo DiCaprio','Jonah Hill',4,1),(2,'IT203858',148,'Christopher Nolan','Leonardo DiCaprio','Joseph Gordon-Levett',0,-1),(3,'IT410421',83,'Gabriela Cowperthwaite','Samantha Berg','James Earl Jones',1,-1),(4,'IT120326',116,'Christopher Nolan','Guy Pearce','Carrie-Anne Moss',2,2),(5,'IT295238',100,'Jimmy Chin','Alex Honnold','Tommy Caldwell',3,0);
